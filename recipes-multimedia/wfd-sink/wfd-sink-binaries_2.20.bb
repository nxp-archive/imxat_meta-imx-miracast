...
SRC_URI[md5sum] = "897423ccd5c9a7114859f4175e493f3d"
SRC_URI[sha256sum] = "97c9070a7988406a6f16a9065b053e4133e48013c7f76799fc8027a835401fa5"
...
do_install() {
    ...
    install -c -m 755 ${S}/usr/bin/wfd_manager ${D}/usr/bin/wfd_manager
